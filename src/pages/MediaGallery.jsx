...
const MediaGallery = () => {
  ...
  const galleries = [
    { name: 'Image Gallery', url: 'https://ongcindia.com/web/eng/media/gallery/image-gallery', icon: <FaImages /> },
    { name: 'Video Gallery', url: 'https://ongcindia.com/web/eng/media/gallery/video-gallery', icon: <FaVideo /> },
  ];

  return (
    <Container>
      <Hero>
        <img src="/images/group_of_companies_header.avif" alt="Media Gallery Hero" />
      </Hero>
      <Breadcrumb>
        <a href="#" onClick={handleGoHome}>Home</a> › <span>Media Gallery</span>
      </Breadcrumb>
      <MainContainer>
