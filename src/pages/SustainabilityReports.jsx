...
const reports = [
    {
        pdf: '/images/IndependentAssurancStatement_FY2023-24.pdf',
        img: '/images/Independent_Assurance.png',
        caption: 'Independent Assurance Statement, 21 Jan 2025',
    },
    {
        pdf: '/images/Final_IR.pdf',
        img: '/images/IR.png',
        caption: 'Final Assurance Statement IR, 24 Aug 2023',
    },
    {
...
const SustainabilityReports = () => {
  ...
  return (
    <Container>
      <Hero>
        <img src="/images/vision_and_mission_header.jpg" alt="Sustainability Reports Hero" />
      </Hero>
      <Breadcrumb>
        <a href="#" onClick={handleGoHome}>Home</a> › <span>Sustainability Reports</span>
      </Breadcrumb>
      <MainContainer>
        <GoHomeButton onClick={handleGoHome}>Go Home</GoHomeButton>
        <SectionTitle>Business Responsibility and Sustainability Report</SectionTitle>
        <ReportGrid>
